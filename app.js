...
async function gununOzetiBildirimiGonder() {
  if (!bildirimlerDesteklerMi() || Notification.permission !== "granted") return;
  if (!getSettings().aiApiKey) return;
  const bugun = today();
...
function whatsappTeslimBildir(s, cariler, servisler) {
  ...
  const mesaj = `Merhaba ${musteri.ad}, ${s.isEmriNo || ""} numaralı işleminiz tamamlandı ve teslime hazır. Tutar: ${fmtTL(s.tutar)}.${kisisellestirme} — As Egzoz & Makine`;
...
function whatsappAnketGonder(s, cariler) {
  ...
  const mesaj = `Merhaba ${musteri ? musteri.ad : ""}, ${s.isEmriNo || ""} numaralı işleminizle ilgili g\xF6r\xFCş\xFCn\xFCz bizim i\xE7in \xE7ok değerli. Kısa bir değerlendirme yapabilir misiniz? ${link} — As Egzoz & Makine`;
...
Bu i\u015Fi hangi teknisyene atamal\u0131y\u0131m? Sadece teknisyenin ad\u0131n\u0131 ve 1 k\u0131sa c\xFCmlelik gerek\xE7eyi yaz, ba\u015Fka hi\xE7bir \u015Fey ekleme. Format: "\u0130sim \u2014 gerek\xE7e"`;
  ...
  const fiyatOnerisiHesapla = () => {
    ...
    const tutarlar = benzerIsler.map((s) => +s.tutar || 0);
    const ortalama = Math.round(tutarlar.reduce((t, v) => t + v, 0) / tutarlar.length);
    return { ortalama, min: Math.min(...tutarlar), max: Math.max(...tutarlar), sayisi: benzerIsler.length };
  };
...
Tutar hakkında yeterli bilgi yoksa tutarOnerisi'ni null yap.`;
  ...
  return React.createElement(
    ...
    React.createElement(Grid4, null,
      ...
      React.createElement(StatCard, { color: C.red, icon: "\u23F3", value: fmtTL(liste.filter((s) => s.durum === "tamamlandi").reduce((t, s) => t + servisKalanTutar(s), 0)), label: "Tahsil Edilecek" }),
      React.createElement(StatCard, { color: C.green, icon: "\u{1F4B0}", value: fmtTL(liste.filter((s) => s.tarih && s.tarih.startsWith(today().slice(0, 7)) && s.durum !== "iptal").reduce((t, s) => t + (+s.tutar || 0), 0)), label: "Bu Ay Ciro" })
    ),
    React.createElement(
      "div",
      { style: S.card },
    ...
    modalAcik && React.createElement(
      ...
      (() => {
        ...
        return React.createElement("div", { style: { fontSize: 11.5, color: C.blue, marginTop: -8, marginBottom: 14, display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" } }, "\u{1F4A1} Ge\xE7mi\u015f ", oneri.sayisi, " benzer i\u015fe g\xF6re ortalama: ", React.createElement("strong", null, fmtTL(oneri.ortalama)), ` (${fmtTL(oneri.min)}\u2013${fmtTL(oneri.max)})`, React.createElement("button", { type: "button", style: { ...S.btnO, padding: "3px 10px", fontSize: 11 }, onClick: () => setForm((f) => ({ ...f, tutar: oneri.ortalama })) }, "Uygula"));
      })(),
      React.createElement(
        "div",
        { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 14, padding: "10px 14px", background: C.surface, borderRadius: 8 } },
...
function Cariler({ hedef, hedefTemizle } = {}) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "fp-fade" }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16, flexWrap: "wrap", gap: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 20, fontWeight: 800, color: C.white } }, "\u{1F465} Cariler"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(IceAktarButonu, { alanlar: [{ baslik: "Ad", key: "ad", zorunlu: true }, { baslik: "Telefon", key: "tel" }, { baslik: "Adres", key: "adres" }], onIceAktar: cariIceAktar }), /* @__PURE__ */ React.createElement("button", { style: S.btn(), onClick: () => {
    ...
    /* @__PURE__ */ React.createElement(StatCard, { color: C.green, icon: "\u{1F4B0}", value: fmtTL(liste.reduce((t, c) => t + harcama(c.id), 0)), label: "Toplam İşlem Hacmi" }),
...
${veri}`;
  ...
  const odemeAlKaydet = () => {
    ...
    hesapHareketiKaydet(odemeAlForm.hesapId, yon, tutar, today(), `${f.tur === "alis" ? "Tedarik\xE7i \xF6demesi" : "Tahsilat"} — ${f.faturaNo} (${cariAd(cariler, f.musteriId)})`, "fatura", yontem);
  ...
  return React.createElement(
      ...
      React.createElement(SiraliTablo, {
        ...
        columns: [
          ...
          { key: "islemler", baslik: "", render: (f) => React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" } },
            f.tur !== "servis" && faturaKalan(f) > 0 && React.createElement("button", { style: { ...S.btnO, padding: "5px 10px", fontSize: 11 }, onClick: () => { setOdemeAlForm({ tutar: faturaKalan(f), hesapId: hesaplar[0] ? hesaplar[0].id : "" }); setOdemeHata(""); setOdemeAlModal(f); } }, f.tur === "alis" ? "💰 Ödeme Yap" : "💰 Ödeme Al"),
    ...
    giderModal && React.createElement(
      ...
      !giderForm.id && React.createElement("label", { style: { ...S.btnO, display: "inline-flex", alignItems: "center", gap: 6, cursor: "pointer", marginBottom: 14 } }, fisOkunuyor ? "⏳ Fiş okunuyor..." : "\u{1F4F7} Fişten Oku", React.createElement("input", { type: "file", accept: "image/*", capture: "environment", disabled: fisOkunuyor, style: { display: "none" }, onChange: fisOku })),
...
function Ayarlar() {
  ...
  sekme === "genel" && React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: S.card }, /* @__PURE__ */ React.createElement("div", { style: S.secTitle }, "\u{1F3E2} Firma Bilgileri"), /* @__PURE__ */ React.createElement(FG, { label: "Firma Ad\u0131" }, /* @__PURE__ */ React.createElement("input", { style: S.inp, value: form.firmaAdi || "", onChange: (e) => setForm((f) => ({ ...f, firmaAdi: e.target.value })) })), /* @__PURE__ */ React.createElement(Grid2, null, /* @__PURE__ */ React.createElement(FG, { label: "Telefon" }, /* @__PURE__ */ React.createElement("input", { style: S.inp, value: form.firmaTel || "", onChange: (e) => setForm((f) => ({ ...f, firmaTel: e.target.value })) })), /* @__PURE__ */ React.createElement(FG, { label: "Varsay\u0131lan KDV Oran\u0131" }, /* @__PURE__ */ React.createElement("select", { style: S.sel, value: form.kdvOrani ?? "", onChange: (e) => setForm((f) => ({ ...f, kdvOrani: +e.target.value })) }, (form.kdvOranlari || KDV_ORANLARI_VARSAYILAN).map((o) => /* @__PURE__ */ React.createElement("option", { key: o, value: o }, "%", o))))), /* @__PURE__ */ React.createElement(FG, { label: "Adres" }, /* @__PURE__ */ React.createElement("input", { style: S.inp, value: form.firmaAdres || "", onChange: (e) => setForm((f) => ({ ...f, firmaAdres: e.target.value })) }))), React.createElement(FirmaLogoYoneticisi, null), React.createElement(
    ...
    "div",
    { style: S.card },
    React.createElement("div", { style: S.secTitle }, "\u{1F3F7}\uFE0F Hizmet T\xFCr\xFC Kategorileri"),
    React.createElement("div", { style: { fontSize: 12, color: C.muted, marginBottom: 14 } }, "Egzoz Tamiri ve Chiptuning sabittir, de\u011Fi\u015Ftirilemez. Di\u011Fer kategorileri d\xFCzenleyebilir, silebilir veya yeni ekleyebilirsiniz."),
    React.createElement(
      "div",
    ...
    React.createElement("button", { type: "button", style: S.btnO, onClick: hizmetEkle }, "\u2795 Yeni Kategori Ekle")
  ), React.createElement(
    "div",
    { style: S.card },
    React.createElement("div", { style: S.secTitle }, "\u{1F4B8} Gider Kategorileri"),
    React.createElement("div", { style: { fontSize: 12, color: C.muted, marginBottom: 14 } }, "Muhasebe \u2192 Giderler b\xF6l\xFCm\xFCnde kullan\u0131lan kategorileri d\xFCzenleyin."),
    React.createElement(
      "div",
      { style: { display: "flex", flexDirection: "column", gap: 8, marginBottom: 12 } },
    ...
    React.createElement("button", { type: "button", style: S.btnO, onClick: giderKategoriEkle }, "\u2795 Yeni Kategori Ekle")
  ), React.createElement(
    "div",
    { style: S.card },
    React.createElement("div", { style: S.secTitle }, "\u{1F9FE} KDV Oranlar\u0131"),
    React.createElement("div", { style: { fontSize: 12, color: C.muted, marginBottom: 14 } }, "Fatura olu\u015ftururken se\xE7ilebilecek KDV oranlar\u0131n\u0131 (%) y\xF6netin. Servis/sat\u0131\u015f/al\u0131\u015f faturas\u0131 olu\u015fturulurken bu listeden se\xE7im yap\u0131l\u0131r."),
    React.createElement(
      "div",
      { style: { display: "flex", flexDirection: "column", gap: 8, marginBottom: 12 } },
    ...
    "div",
    { style: S.card },
    React.createElement("div", { style: S.secTitle }, "\u{1F4C4} Resmi Ödeme Hatırlatıcıları"),
    React.createElement("div", { style: { fontSize: 12, color: C.muted, marginBottom: 14 } }, "KDV, muhtasar, SGK gibi d\xF6nemsel \xF6demeleri hat\u0131rlatmak i\xE7in her ay\u0131n hangi g\xFCn\xFCnde uyar\u0131lmak istedi\u011Finizi girin. Tarihler \xF6rnektir, muhasebecinizle teyit edin."),
    React.createElement(
      "div",
      { style: { display: "flex", flexDirection: "column", gap: 8, marginBottom: 12 } },
...
function Araclar({ hedef, hedefTemizle } = {}) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "fp-fade" }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16, flexWrap: "wrap", gap: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 20, fontWeight: 800, color: C.white } }, "🚗 Araç Kayıtları"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(IceAktarButonu, { alanlar: [{ baslik: "Plaka", key: "plaka", zorunlu: true }, { baslik: "Marka", key: "marka" }, { baslik: "Model", key: "model" }, { baslik: "Yıl", key: "yil" }], onIceAktar: aracIceAktar }), /* @__PURE__ */ React.createElement("button", { style: S.btn(), onClick: () => {
    ...
    /* @__PURE__ */ React.createElement(StatCard, { color: C.blue, icon: "👤", value: liste.filter((a) => a.musteriId).length, label: "Sahibi Bilinen Araç" }),
    /* @__PURE__ */ React.createElement(StatCard, { color: C.yellow, icon: "❓", value: liste.filter((a) => !a.musteriId).length, label: "Sahibi Bilinmiyor" }),
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { padding: "0 4px 14px", display: "flex", gap: 6 } },
      ...
      /* @__PURE__ */ React.createElement("div", { style: { position: "relative" } },
        /* @__PURE__ */ React.createElement("button", { type: "button", title: "H\u0131zl\u0131 Ekle", style: { ...S.btn(), padding: "9px 13px", fontSize: 15, lineHeight: 1 }, onClick: () => setHizliMenuAcik((v) => !v) }, "\u2795"),
